...
import { reset, saveResetToken, verifyResetPassword2FA } from "../../redux/slices/userReducer";
...
const TwoFactorAuthForgotPassword = () => {
...
export default TwoFactorAuthForgotPassword;
