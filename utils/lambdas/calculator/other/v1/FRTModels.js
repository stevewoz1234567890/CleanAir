...
const calcStoreSchema = new Schema({
    groupDt : {
        type : Date,
        required : true
    },
...
const PiValuesDebug = mongoose.model('PiValuesDebug', piValueSchema, 'piValuesDebug');
const FormulaValue = mongoose.model('FormulaValue', formulaValueSchema, 'formulaValues');
const DebugFormulaValue = mongoose.model('DebugFormulaValue', formulaValueSchema, 'formulaValuesDebug');
...
module.exports = {
    Formula,Flare,Header,
    Sensor,PiTag,EventRule,
    Parameter,Compound, Constant,
    FormulaValue,PiValue,
    CompoundGroup, Event, PiValuesDebug,
    CalcStore, DebugFormulaValue
}
